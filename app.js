...
var author$project$Main$Page_None = {$: 'Page_None'};
...
var author$project$Display$init = F2(
	function (flags, initString) {
		return _Utils_Tuple2(
			{message: 'Hello this is display'},
...
var author$project$Main$Msg_Display = function (a) {
	return {$: 'Msg_Display', a: a};
};
var author$project$Main$Msg_Home = function (a) {
	return {$: 'Msg_Home', a: a};
};
var author$project$Main$Page_Display = function (a) {
	return {$: 'Page_Display', a: a};
};
...
var author$project$Main$loadCurrentPage = function (_n0) {
	...
	var _n1 = function () {
		...
		switch (_n2.$) {
			case 'HomeRoute':
				var _n3 = author$project$Home$init(model.flags);
				var pageModel = _n3.a;
				var pageCmd = _n3.b;
				return _Utils_Tuple2(
					author$project$Main$Page_Home(pageModel),
					A2(elm$core$Platform$Cmd$map, author$project$Main$Msg_Home, pageCmd));
			case 'DisplayRoute':
				var thing = _n2.a;
				var _n4 = A2(author$project$Display$init, model.flags, thing);
				var pageModel = _n4.a;
				var pageCmd = _n4.b;
				return _Utils_Tuple2(
					author$project$Main$Page_Display(pageModel),
					A2(elm$core$Platform$Cmd$map, author$project$Main$Msg_Display, pageCmd));
			default:
				return _Utils_Tuple2(author$project$Main$Page_None, elm$core$Platform$Cmd$none);
		}
	}();
	var page = _n1.a;
	var newCmd = _n1.b;
...
var author$project$Routes$DisplayRoute = function (a) {
	return {$: 'DisplayRoute', a: a};
};
...
var author$project$Routes$matchers = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			author$project$Routes$DisplayRoute,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('display'),
...
var author$project$Main$init = F3(
	function (flags, url, navKey) {
		var model = {
			flags: flags,
			navKey: navKey,
			page: author$project$Main$Page_None,
...
var author$project$Display$update = F3(
		...
		switch (_n0.a.$) {
			...
			case 'Msg_Home':
				if (_n0.b.$ === 'Page_Home') {
					...
					var _n2 = A2(author$project$Home$update, subMsg, pageModel);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$Page_Home(newPageModel)
							}),
						A2(elm$core$Platform$Cmd$map, author$project$Main$Msg_Home, newCmd));
				} else {
					var subMsg = _n0.a.a;
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			default:
				if (_n0.b.$ === 'Page_Display') {
					var subMsg = _n0.a.a;
					var pageModel = _n0.b.a;
					var _n3 = A3(author$project$Display$update, model.flags, subMsg, pageModel);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$Page_Display(newPageModel)
							}),
						A2(elm$core$Platform$Cmd$map, author$project$Main$Msg_Display, newCmd));
				} else {
					var subMsg = _n0.a.a;
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
...
var author$project$Display$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Routes$pathFor = function (route) {
	switch (route.$) {
		...
		case 'DisplayRoute':
			var thing = route.a;
			return '/display/' + thing;
		default:
			return '/';
	}
};
var author$project$Routes$homePath = author$project$Routes$pathFor(author$project$Routes$HomeRoute);
...
var author$project$Main$nav = function (model) {
	var linkToHome = A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$href(author$project$Routes$homePath),
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('mb-2 text-white bg-black p-4')
			]),
		links);
};
	...
	var page = function () {
		...
		switch (_n0.$) {
			case 'Page_Home':
				...
				return A2(
					elm$html$Html$map,
					author$project$Main$Msg_Home,
					author$project$Home$view(pageModel));
			case 'Page_Display':
				var pageModel = _n0.a;
				return A2(
					elm$html$Html$map,
					author$project$Main$Msg_Display,
					author$project$Display$view(pageModel));
			default:
